...
export const OutreachBotAgent = {
    ...
    execute: async (context) => {
        ...
        if (candidates.length === 0) {
            return { status: 'success', summary: 'No high-potential outreach candidates found this week.', findings: [] };
        }
        ...
        for (const page of candidates) {
            ...
            let draft = { subjectLine: 'Re: Content Collaboration', emailBody: 'Hi there...' };
            try { draft = JSON.parse(aiRes.text); } catch (e) {}
