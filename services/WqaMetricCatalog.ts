...
export const WQA_METRICS: MetricDefinition[] = [
	...
	},
	{
		...
		surfaces: ["grid", "inspector"],
		requires: ["ga4"],
		industries: ["ecommerce", "saas", "real_estate"],
		width: "80px",
	},
	{
		key: "ga4Conversions",
	...
	},
	{
		...
		level: "page",
		surfaces: ["grid", "inspector"],
		industries: ["healthcare", "finance", "news", "blog"],
		width: "80px",
	},
	{
		key: "contentAge",
	...
	},
	{
		...
		level: "page",
		surfaces: ["grid", "inspector"],
		industries: ["news", "blog", "restaurant"],
		width: "110px",
	},
	{
		key: "contentDecayRisk",
		label: "Decay Risk",
		role: "content",
		level: "page",
		surfaces: ["grid", "inspector"],
	...
	{
		key: "newsSitemapCoverage",
		label: "News Sitemap Coverage",
		role: "industry",
		level: "site",
		surfaces: ["sidebar", "site"],
		industries: ["news"],
	},
	{
		key: "articleSchemaCoverage",
	...
	{
		key: "wwwInconsistency",
		label: "WWW Inconsistency",
		role: "indexing",
		level: "site",
		surfaces: ["sidebar", "site"],
	},
...
export function isMetricVisible(
	...
	if (m.excludeIndustries && m.excludeIndustries.includes(ctx.industry))
		return false;
	...
	if (ctx.lowIndustryConfidence && m.industries && m.industries.length > 0)
		return false;
	return true;
}
...
export function getMetricsForSurface(
	...
	return WQA_METRICS.filter(
		(m) => m.surfaces.includes(surface) && isMetricVisible(m, ctx),
	);
}
