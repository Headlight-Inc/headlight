...
export const checkSaasDocs: CheckEvaluator = (page) => {
	...
	return {
		...
		message: hasDocs
			...
			: "No clear link to documentation or help center found.",
		auditModes: ["full"],
		industries: ["saas"],
	};
};
...
export const checkSaasStatusPage: CheckEvaluator = (page) => {
	...
	return {
		...
		message: hasStatus
			? "Status page link found."
			: "No service status page link found.",
		auditModes: ["full"],
		industries: ["saas"],
	};
};
...
export const checkSaasChangelog: CheckEvaluator = (page) => {
	...
	return {
		...
		message: hasChangelog
			? "Changelog or release notes link found."
			: "No changelog or release notes link found.",
		auditModes: ["full"],
		industries: ["saas"],
	};
};
...
export const checkSaasIntegrations: CheckEvaluator = (page) => {
	...
	return {
		...
		message: hasIntegrations
			? "Integrations page link found."
			: "No integrations or marketplace page link found.",
		auditModes: ["full"],
		industries: ["saas"],
	};
};
...
export const checkSaasComparison: CheckEvaluator = (page) => {
	...
	return {
		...
		message: hasComparison
			? "Comparison-page link found."
			: "No comparison or alternative page link found.",
...
export const checkSaasSecurity: CheckEvaluator = (page) => {
	...
	return {
		...
		tier: 4,
		category: "saas",
		name: "Security / Compliance Page",
		severity: hasSecurity ? "pass" : "info",
		value: { hasSecurity },
		expected: "Security, trust, or compliance page visible from the main site",
		message: hasSecurity
			? "Security or compliance page link found."
			: "No security or compliance page link found.",
		auditModes: ["full", "security"],
		industries: ["saas"],
	};
};
