...
export const COMPARISON_ROWS: ComparisonRowDef[] = [
	...
	},
	{
		...
		profileKey: "domainAge",
		format: "number",
		source: "dns",
		tooltip: "RDAP registration date or Wayback first capture",
	},
	{
		id: "bp-value-prop",
		category: "Business Profile",
		label: "Value Proposition",
		profileKey: "valueProposition",
		format: "text",
		source: "ai",
	},
	{
		...
		profileKey: "employeeCountEstimate",
		format: "text",
		source: "ai",
	},
	{
	...
	},
	{
		...
		category: "Business Profile",
		label: "First Seen",
		profileKey: "firstSeenDate",
		format: "text",
		source: "dns",
		tooltip: "Wayback or RDAP first seen date",
	},

	{
		id: "sv-organic-traffic",
		category: "Search Visibility",
		label: "Est. Organic Traffic",
		profileKey: "estimatedOrganicTraffic",
		format: "number",
		source: "external",
	},
	{
		id: "sv-traffic-trend",
		category: "Search Visibility",
		label: "Traffic Trend (30d %)",
		profileKey: "trafficTrend30d",
		format: "number",
		source: "external",
		tooltip: "+ growing, - declining",
	},
	{
		id: "sv-total-kw",
		category: "Search Visibility",
		label: "Total Ranking Keywords",
		profileKey: "totalRankingKeywords",
		format: "number",
		source: "external",
	},
	{
	...
	},
	{
		...
		profileKey: "brandedSearchVolume",
		format: "number",
		source: "external",
	},
	{
		...
		profileKey: "shareOfVoice",
		format: "score_100",
		source: "computed",
	},
	{
		id: "sv-keyword-overlap",
		category: "Search Visibility",
		label: "Keyword Overlap %",
		profileKey: "keywordOverlapPct",
		format: "number",
		source: "computed",
	},
	{
	...
	},
	{
		...
		profileKey: "featuredSnippetCount",
		format: "number",
		source: "crawl",
	},
	{
		id: "sv-knowledge-panel",
		category: "Search Visibility",
		label: "Has Knowledge Panel?",
		profileKey: "hasKnowledgePanel",
		format: "boolean",
		source: "external",
	},
	{
...

	{
		...
		profileKey: "totalIndexablePages",
		format: "number",
		source: "sitemap",
	},
	{
	...
	},
	{
		...
		profileKey: "contentTypeBreakdown",
		format: "text",
		source: "crawl",
	},
	{
		id: "ct-blog-active",
		category: "Content",
		label: "Actively Blogging?",
		profileKey: "isActivelyBlogging",
		format: "boolean",
		source: "sitemap",
	},
	{
	...
	},
	{
		...
		profileKey: "contentQualityAssessment",
		format: "text",
		source: "ai",
	},
	{
		...
		profileKey: "contentFreshnessScore",
		format: "score_100",
		source: "sitemap",
	},
	{
		id: "ct-velocity-trend",
		category: "Content",
		label: "Publishing Velocity Trend %",
		profileKey: "contentVelocityTrend",
		format: "number",
		source: "sitemap",
	},
	{
		...
		profileKey: "topicCoverageBreadth",
		format: "number",
		source: "crawl",
	},
	{
		...
		profileKey: "contentEfficiency",
		format: "number",
		source: "computed",
		tooltip: "Traffic per indexable page",
	},
	{
		id: "ct-duplicate-pct",
		category: "Content",
		label: "Duplicate Content %",
		profileKey: "duplicateContentPct",
		format: "number",
		source: "crawl",
	},
	{
	...
	},
	{
		id: "ct-avg-images",
		category: "Content",
		label: "Avg Images Per Article",
		profileKey: "avgImagesPerArticle",
		format: "number",
		source: "crawl",
	},
	{
		id: "ct-embeds-video",
		category: "Content",
		label: "Uses Video in Articles?",
		profileKey: "embedsVideoInArticles",
		format: "boolean",
		source: "crawl",
	},
	{
		id: "ct-avg-internal-links",
		category: "Content",
		label: "Avg Internal Links Per Page",
		profileKey: "avgInternalLinksPerPage",
		format: "number",
		source: "crawl",
	},
	{
	...
	},
	{
		...
		category: "Authority & Links",
		label: "Citation Flow",
		profileKey: "majesticCitationFlow",
		format: "score_100",
		source: "external",
	},
	{
		...
		category: "Authority & Links",
		label: "Spam Score",
		profileKey: "mozSpamScore",
		format: "number",
		source: "external",
		tooltip: "Lower is better (0-100)",
	},
	{
		id: "al-rd",
		category: "Authority & Links",
		label: "Referring Domains",
		profileKey: "referringDomains",
		format: "number",
		source: "external",
	},
	{
	...
	},
	{
		id: "al-velocity",
		category: "Authority & Links",
		label: "Link Velocity (60d)",
		profileKey: "linkVelocity60d",
		format: "number",
		source: "external",
	},
	{
		id: "al-quality",
		category: "Authority & Links",
		label: "Backlink Quality Score",
		profileKey: "backlinkQualityScore",
		format: "score_100",
		source: "computed",
	},
	{
		id: "al-common",
		category: "Authority & Links",
		label: "Common Linking Domains",
		profileKey: "commonBacklinkDomains",
		format: "number",
		source: "computed",
	},
	{
		id: "al-avg-rd-content",
		category: "Authority & Links",
		label: "Avg RD to Content Pages",
		profileKey: "avgRefDomainsToContentPages",
		format: "number",
		source: "computed",
	},

	{
		...
		label: "Tech Health Score",
		profileKey: "techHealthScore",
		format: "score_100",
		source: "computed",
	},
	{
		id: "th-speed",
		category: "Technical Health",
		label: "Site Speed Score",
		profileKey: "siteSpeedScore",
		format: "score_100",
		source: "psi",
	},
	{
	...
	},
	{
		...
		profileKey: "mobileFriendlinessScore",
		format: "score_100",
		source: "psi",
	},
	{
	...
	},
	{
		id: "th-js-dep",
		category: "Technical Health",
		label: "JS Render Dependency %",
		profileKey: "jsRenderDependencyPct",
		format: "number",
		source: "crawl",
	},
	{
	...
	},
	{
		id: "th-seo-quality",
		category: "Technical Health",
		label: "On-Page SEO Quality",
		profileKey: "onPageSeoQuality",
		format: "text",
		source: "crawl",
	},
	...
	},
	{
		...
		profileKey: "avgCitationWorthiness",
		format: "score_100",
		source: "ai",
	},
	{
	...
	},
	{
		id: "ai-bot-policy",
		category: "AI Discoverability",
		label: "AI Bot Access Policy",
		profileKey: "aiBotAccessPolicy",
		format: "text",
		source: "crawl",
	},
	{
		id: "ai-passage-pct",
		category: "AI Discoverability",
		label: "Passage-Ready Content %",
		profileKey: "passageReadyPct",
		format: "number",
		source: "crawl",
	},
	{
		...
		profileKey: "featuredSnippetReadyPct",
		format: "number",
		source: "crawl",
	},
	...
	},
	{
		...
		profileKey: "conversionPathCount",
		format: "number",
		source: "crawl",
	},
	{
		id: "ux-cta",
		category: "User Experience & Conversion",
		label: "CTA Density Score",
		profileKey: "ctaDensityScore",
		format: "score_100",
		source: "crawl",
	},
	{
	...
	},
	{
		id: "ux-optin",
		category: "User Experience & Conversion",
		label: "Email Opt-In Quality",
		profileKey: "emailOptInQuality",
		format: "text",
		source: "crawl",
	},
	{
...

	{
		...
		profileKey: "socialTotalFollowers",
		format: "number",
		source: "computed",
	},
	{
		id: "social-growth",
		category: "Social Media",
		label: "Social Growth Rate %",
		profileKey: "socialGrowthRate",
		format: "number",
		source: "computed",
	},
	{
	...
	},
	{
		id: "fb-posts",
		category: "Social Media",
		label: "Facebook Posts/Mo",
		profileKey: "facebookUpdatesPerMonth",
		format: "number",
		source: "social_api",
	},
	{
		...
		profileKey: "facebookEngagementLevel",
		format: "text",
		source: "social_api",
	},
	{
	...
	},
	{
		...
		category: "Social Media",
		label: "X Posts/Mo",
		profileKey: "twitterUpdatesPerMonth",
		format: "number",
		source: "social_api",
	},
	{
	...
	},
	{
		id: "ig-likes",
		category: "Social Media",
		label: "Instagram Avg Likes",
		profileKey: "instagramAvgImageLikes",
		format: "number",
		source: "social_api",
	},
	{
	...
	},
	{
		id: "yt-posts",
		category: "Social Media",
		label: "YouTube Uploads/Mo",
		profileKey: "youtubeUpdatesPerMonth",
		format: "number",
		source: "social_api",
	},
	{
...

	{
		...
		label: "Est. PPC Clicks/Mo",
		profileKey: "adsTraffic",
		format: "number",
		source: "external",
	},
	{
		id: "paid-cost",
		category: "Paid & Advertising",
		label: "Est. Ad Budget/Mo",
		profileKey: "adsTrafficCost",
		format: "currency",
		source: "external",
	},
	{
		id: "paid-kw",
		category: "Paid & Advertising",
		label: "PPC Keywords Count",
		profileKey: "ppcKeywordsCount",
		format: "number",
		source: "external",
	},
	{
		id: "paid-display",
		category: "Paid & Advertising",
		label: "Display Ads Count",
		profileKey: "displayAdsCount",
		format: "number",
		source: "crawl",
	},
	{
		id: "paid-platforms",
		category: "Paid & Advertising",
		label: "Ad Platforms Detected",
		profileKey: "adPlatformsDetected",
		format: "list",
		source: "crawl",
	},
	{
		...
		profileKey: "hasConversionTracking",
		format: "boolean",
		source: "crawl",
	},
	{
		id: "paid-remarketing",
		category: "Paid & Advertising",
		label: "Remarketing Tags?",
		profileKey: "hasRemarketingTags",
		format: "boolean",
		source: "crawl",
	},

	{
		id: "rv-aggregate-score",
		category: "Reviews & Reputation",
		label: "Overall Review Score",
		profileKey: "aggregateReviewScore",
		format: "rating_5",
		source: "computed",
	},
	{
		id: "rv-aggregate-count",
		category: "Reviews & Reputation",
		label: "Total Reviews",
		profileKey: "aggregateReviewCount",
		format: "number",
		source: "computed",
	},
	{
		...
		profileKey: "trustpilotScore",
		format: "rating_5",
		source: "external",
	},
	{
		id: "rv-trustpilot-count",
		category: "Reviews & Reputation",
		label: "Trustpilot Reviews",
		profileKey: "trustpilotReviewCount",
		format: "number",
		source: "external",
	},
	{
	...
	},
	{
		id: "rv-capterra",
		category: "Reviews & Reputation",
		label: "Capterra Rating",
		profileKey: "capterraRating",
		format: "rating_5",
		source: "external",
	},
	{
		id: "rv-capterra-count",
		category: "Reviews & Reputation",
		label: "Capterra Reviews",
		profileKey: "capterraReviewCount",
		format: "number",
		source: "external",
	},
	{
	...
	},
	{
		...
		profileKey: "googleReviewCount",
		format: "number",
		source: "external",
	},
	{
		id: "rv-brand-mentions",
		category: "Reviews & Reputation",
		label: "Unlinked Brand Mentions",
		profileKey: "brandMentionCount",
		format: "number",
		source: "ai",
	},
	{
		id: "rv-landing-pages",
		category: "Reviews & Reputation",
		label: "Targeted Landing Pages?",
		profileKey: "hasTargetedLandingPages",
		format: "boolean",
		source: "crawl",
	},

	{
		...
		label: "Same Products/Services?",
		profileKey: "offersSameProducts",
		format: "boolean",
		source: "ai",
	},
	{
	...
	},
	{
		id: "ec-product-words",
		category: "E-commerce & Pricing",
		label: "Product Page Avg Words",
		profileKey: "productPageAvgWordCount",
		format: "number",
		source: "crawl",
	},
	{
		...
		category: "E-commerce & Pricing",
		label: "Schema on Products?",
		profileKey: "hasSchemaOnProducts",
		format: "boolean",
		source: "crawl",
	},

	{
		id: "loc-rank",
		category: "Local SEO",
		label: "Local Keyword Ranking",
		profileKey: "localKeywordRanking",
		format: "number",
		source: "external",
	},
	{
	...
	},
	{
		id: "loc-press",
		category: "Local SEO",
		label: "Local Press Coverage?",
		profileKey: "localPressCoverage",
		format: "boolean",
		source: "external",
	},
	{
		id: "loc-citations",
		category: "Local SEO",
		label: "Quality Citations?",
		profileKey: "qualityCitationsPresent",
		format: "boolean",
		source: "external",
	},
	{
		id: "loc-pages",
		category: "Local SEO",
		label: "Optimized Local Pages?",
		profileKey: "hasOptimizedLocalPages",
		format: "boolean",
		source: "crawl",
	},

	{
		id: "tp-organic-1",
		category: "Top Pages",
		label: "Top Organic Page #1",
		profileKey: "topOrganicPages.0.url",
		format: "url",
		source: "external",
	},
	{
		id: "tp-organic-2",
		category: "Top Pages",
		label: "Top Organic Page #2",
		profileKey: "topOrganicPages.1.url",
		format: "url",
		source: "external",
	},
	{
		id: "tp-organic-3",
		category: "Top Pages",
		label: "Top Organic Page #3",
		profileKey: "topOrganicPages.2.url",
		format: "url",
		source: "external",
	},
	{
		id: "tp-blog-1",
		category: "Top Pages",
		label: "Top Blog Page #1",
		profileKey: "topBlogPages.0.url",
		format: "url",
		source: "crawl",
	},
	{
		id: "tp-blog-2",
		category: "Top Pages",
		label: "Top Blog Page #2",
		profileKey: "topBlogPages.1.url",
		format: "url",
		source: "crawl",
	},
	{
		id: "tp-blog-3",
		category: "Top Pages",
		label: "Top Blog Page #3",
		profileKey: "topBlogPages.2.url",
		format: "url",
		source: "crawl",
	},
	{
		id: "tp-ecom-1",
		category: "Top Pages",
		label: "Top Product Page #1",
		profileKey: "topEcomPages.0.url",
		format: "url",
		source: "crawl",
	},
	{
		id: "tp-ecom-2",
		category: "Top Pages",
		label: "Top Product Page #2",
		profileKey: "topEcomPages.1.url",
		format: "url",
		source: "crawl",
	},
	{
		id: "tp-ecom-3",
		category: "Top Pages",
		label: "Top Product Page #3",
		profileKey: "topEcomPages.2.url",
		format: "url",
		source: "crawl",
	},

	{
		...
		profileKey: "threatLevel",
		format: "text",
		source: "computed",
	},
	{
		id: "to-content-threat",
		category: "Threat & Opportunity",
		label: "Content Threat Score",
		profileKey: "contentThreatScore",
		format: "score_100",
		source: "computed",
	},
	{
		id: "to-authority-threat",
		category: "Threat & Opportunity",
		label: "Authority Threat Score",
		profileKey: "authorityThreatScore",
		format: "score_100",
		source: "computed",
	},
	{
		id: "to-innovation-threat",
		category: "Threat & Opportunity",
		label: "Innovation Threat Score",
		profileKey: "innovationThreatScore",
		format: "score_100",
		source: "computed",
	},
	{
		...
		profileKey: "opportunityAgainstThem",
		format: "score_100",
		source: "computed",
	},
];
