...
export class CommonCrawlService {
     ...
     */
    static async discoverBacklinks(domain: string, onProgress?: (msg: string) => void): Promise<CommonCrawlBacklink[]> {
     ...
     */
    static async enrichSession(sessionId: string, domain: string, onProgress?: (msg: string) => void): Promise<{ discovered: number }> {
