...
export function getConversionValue(
	...
	switch (industry) {
		case "ecommerce":
			return Number(page.ga4Revenue || page.ga4EcommerceRevenue || 0);
		case "news":
		case "blog":
			return Number(page.ga4Views || 0);
		case "local":
			return Number(page.ga4GoalCompletions || page.ga4Conversions || 0);
		case "saas":
			return Number(page.ga4Conversions || 0);
		default:
			return Number(page.ga4Conversions || 0);
	}
}
