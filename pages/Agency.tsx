		...
		<div className="min-h-screen bg-[#F3F5F7] font-sans">
			...
			<div className="bg-[#080808] text-white py-24 relative overflow-hidden">
				...
				<div className="max-w-7xl mx-auto px-4 text-center relative z-10">
					...
					<Button size="lg" variant="red" className="shadow-float">
			...
			<div className="max-w-7xl mx-auto px-4 py-20">
				<div className="text-center mb-16">
					<h2 className="text-sm font-bold text-[#F5364E] uppercase tracking-widest mb-2">
						Our Plans
					</h2>
					...
					<div className="grid md:grid-cols-3 gap-8 text-center">
						<div>
							...
							<p className="text-sm text-gray-500 mt-2">
								We use AI to keep costs down, so your budget goes to results.
							</p>
						</div>
						<div>
							<div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4 text-[#F5364E]">
							...
							<p className="text-sm text-gray-500 mt-2">
								You get a real person to talk to who knows your business.
							</p>
						</div>
						<div>
							<div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4 text-[#F5364E]">
							...
							<p className="text-sm text-gray-500 mt-2">
								We help build your brand reputation, not just keyword rankings.
							</p>
						</div>
					</div>
				</div>
...
const PricingCard = ({
	...
	<Card
		className={`flex flex-col h-full border transition-all duration-300 ${highlight ? "border-[#F5364E] shadow-float scale-105 z-10" : "border-gray-200 hover:border-gray-300"}`}
	>
		{highlight && (
		...
		<div className="mb-6">
			...
			<p className="text-xs font-bold text-[#F5364E] mt-1 uppercase tracking-wider">
				{target}
			</p>
			<div className="flex items-baseline gap-1 mt-4">
				<span
					className={`text-2xl font-light ${highlight ? "text-[#F5364E]" : "text-gray-900"}`}
				>
					{priceRange}
				</span>
		...
		<ul className="space-y-4 mb-8 flex-1">
			{features.map((f, i) => (
				<li key={i} className="flex items-start gap-3">
					<div
						className={`mt-1 w-4 h-4 rounded-full flex items-center justify-center shrink-0 ${highlight ? "bg-red-50 text-[#F5364E]" : "bg-gray-100 text-gray-500"}`}
					>
		...
		<Button
			variant={highlight ? "red" : "secondary"}
