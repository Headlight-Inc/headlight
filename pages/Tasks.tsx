					...
					<div className="flex justify-between items-center mb-6">
						<div>
							...
							<p className="text-sm text-gray-500">
								Manage and track your SEO execution roadmap.
							</p>
						</div>
							...
							{viewMode !== "board" && viewMode !== "list" && (
								<div className="h-full flex flex-col items-center justify-center text-gray-500 py-20 bg-white/[0.02] rounded-3xl border border-dashed border-white/5">
									...
									<p className="max-w-md text-center">
										We're building advanced project management views to help you
										execute faster.
									</p>
								</div>
							)}
				...
				>
					<div className="flex items-center justify-between px-2">
						<div className="flex items-center gap-2">
							...
							></div>
							<h3 className="font-bold text-white uppercase tracking-widest text-[11px]">
								{col.label}
							</h3>
						</div>
						...
						{tasks
							...
							.map((task) => (
								...
								>
									...
									<h4 className="text-sm font-bold text-white group-hover:text-brand-red transition-colors mb-3">
										{task.title}
									</h4>
						...
						>
							<td className="px-6 py-4">
								...
								<div className="text-[10px] text-gray-500 mt-1">
									{task.source} • {task.category || "General"}
								</div>
							</td>
							<td className="px-6 py-4">
								<span
...
const CollaborationOverlayWrapper = ({
	isOpen,
	onClose,
	target,
	tasks,
