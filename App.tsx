...
const ProtectedRoute = ({ children }: { children: React.ReactNode }) => {
	...
	if (loading)
		return (
			<div className="h-screen bg-[#080808] text-white flex items-center justify-center">
				Loading...
			</div>
		);
					...
					<BrowserRouter>
						...
						>
							<Routes>
								...
								/>
								<Route
									path="/project/:projectId/crawler"
									element={
										<ProtectedRoute>
											<SeoCrawler />
										</ProtectedRoute>
