		...
		<nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 h-[76px] flex items-center">
			<div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex justify-between items-center">
				...
				<Link to="/" className="flex items-center gap-3 group">
					<svg
						...
						className="shrink-0 text-gray-900 group-hover:text-black transition-colors"
					>
				...
				<div className="hidden md:flex items-center gap-4">
					<Link
						to="/auth"
						className="text-sm font-bold text-gray-500 hover:text-brand-red uppercase tracking-wide"
					>
						Log in
					</Link>
			...
			{isOpen && (
				<div className="absolute top-[76px] left-0 w-full bg-white border-b border-gray-200 p-6 flex flex-col gap-4 md:hidden shadow-lg animate-in slide-in-from-top-5">
					<Link
						to="/"
						className="text-gray-600 font-bold uppercase tracking-wide py-2"
					>
						Home
					</Link>
					<Link
					...
					<div className="flex flex-col gap-3 mt-4">
						<Link
							to="/auth"
							className="text-center py-3 text-gray-600 font-bold uppercase tracking-wide border-b border-gray-100"
						>
							Log in
						</Link>
						<Link to="/auth?mode=signup">
