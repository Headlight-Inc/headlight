...
export const CopilotOverlay = ({
	...
	>([
		{
			role: "ai",
			text: "Hello. I'm Headlight. I've looked at your latest data. You have 3 critical errors and a new competitor in the top 10. What would you like to handle first?",
		},
	]);
	...
	const handleSend = async () => {
		...
		try {
			...
			const response = await router.complete({
				...
				systemPrompt:
					"You are HeadlightSEO's AI Copilot. You help business owners understand their website performance. Explain things in very simple, plain English. Avoid complex SEO jargon like 'canonicalization' or 'link equity' unless you explain them simply first. Be helpful and concise.",
