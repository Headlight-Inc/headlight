...
const TABS: Array<{ id: WqaSidebarTab; label: string; Icon: React.ElementType }> = [
...
export default function WqaSidebarRouter({ embedded = false }: { embedded?: boolean }) {
    const { wqaSidebarTab, setWqaSidebarTab, auditSidebarWidth, setIsDraggingSidebar } = useSeoCrawler();
