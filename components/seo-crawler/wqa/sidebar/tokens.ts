...
export const toneColor = (t: WqaSidebarTone): string => {
	switch (t) {
		case "good":
			return WQA_SIDEBAR_TOKENS.good;
		case "warn":
			return WQA_SIDEBAR_TOKENS.warn;
		case "bad":
			return WQA_SIDEBAR_TOKENS.bad;
		case "accent":
			return WQA_SIDEBAR_TOKENS.accent;
		default:
			return WQA_SIDEBAR_TOKENS.textMuted;
	}
};
