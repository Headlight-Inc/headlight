...
import {
  ...
  LayoutDashboard, ListChecks, Search, FileText, Link2, Wrench, Zap, History
} from 'lucide-react';
...
export default function WqaInspectorShell() {
  ...
  }, [selectedPage, wqaInspectorTab, setWqaInspectorTab, setSelectedPage]);
    ...
    >
      ...
      <div className="h-[34px] border-b border-[#222] flex items-center px-3 justify-between bg-[#0a0a0a] shrink-0">
        <div className="flex h-full overflow-x-auto custom-scrollbar-hidden flex-1 mr-4">
          {baseTabs.map(({ id, label, Icon, count }) => {
