	...
	return (
		<div>
			...
			<div className="flex flex-wrap gap-2 mb-5">
				<StatusBadge
					status={schemaTypes.includes("JobPosting") ? "pass" : "fail"}
					label="JobPosting schema"
				/>
				<StatusBadge
					status={sig.hasSalary ? "pass" : "warn"}
					label="Salary present"
				/>
				<StatusBadge
					status={sig.hasExpirationDate ? "pass" : "warn"}
					label="Expiration date"
				/>
				<StatusBadge
					status={sig.hasApplyCta ? "pass" : "warn"}
					label="Apply CTA"
				/>
			</div>
