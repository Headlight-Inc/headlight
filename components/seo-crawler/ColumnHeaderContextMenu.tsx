...
export default function ColumnHeaderContextMenu({
	...
	const safeX =
		typeof window !== "undefined" ? Math.min(x, window.innerWidth - 220) : x;
	const safeY =
		typeof window !== "undefined" ? Math.min(y, window.innerHeight - 150) : y;
