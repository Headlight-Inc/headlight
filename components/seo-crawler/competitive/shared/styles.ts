...
export const CARD_NESTED =
	"rounded-lg border border-[#191919] bg-[#0a0a0c] p-3";
export const CARD_HIGHLIGHT =
	"rounded-xl border border-[#F5364E]/20 bg-[#F5364E]/5 p-4";

// Section headers
export const SECTION_HEADER =
	"text-[11px] font-semibold uppercase tracking-wider text-[#555]";
...
// "YOU" badge
export const YOU_BADGE =
	"rounded px-1 py-0.5 text-[8px] font-black uppercase bg-[#F5364E]/15 text-[#F5364E]";
...
export const EMPTY_STATE_BOX =
	"rounded-xl border border-dashed border-[#222] bg-[#0a0a0c] py-10 text-center";
...
export const SIDEBAR_SCROLL =
	"custom-scrollbar h-full space-y-4 overflow-y-auto";
export const VIEW_SCROLL =
	"custom-scrollbar flex-1 overflow-y-auto p-4 space-y-4";
