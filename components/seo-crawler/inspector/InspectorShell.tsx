...
const TABS: Array<{
	...
	{ id: "content", label: "Content" },
	{
		id: "links",
		label: "Links",
		count: (page) => Number(page?.inlinks || 0) + Number(page?.outlinks || 0),
	},
	{
		id: "schema",
		label: "Schema",
	...
	{ id: "performance", label: "Performance" },
	{
		id: "images",
		label: "Images",
		count: (page) => Number(page?.totalImages || 0),
	},
	{ id: "social", label: "Social" },
	{
		...
		label: "GSC",
		count: (page) =>
			page?.gscClicks !== undefined && page?.gscClicks !== null
				? Number(page.gscClicks)
				: undefined,
	},
	{
		id: "ga4",
		label: "GA4",
		count: (page) =>
			page?.ga4Sessions !== undefined && page?.ga4Sessions !== null
				? Number(page.ga4Sessions)
				: undefined,
	},
	{ id: "ai", label: "AI" },
	...
	return (
		...
		>
			...
			<div className="h-[28px] border-b border-[#1a1a1a] flex items-center px-4 bg-[#0d0d0d] shrink-0">
				<span className="text-[11px] font-mono text-[#F5364E] font-medium">
					PAGE DETAIL:
				</span>
				<span className="text-[11px] font-mono text-blue-400 ml-2 truncate">
					{selectedPage.url}
				</span>
			</div>
