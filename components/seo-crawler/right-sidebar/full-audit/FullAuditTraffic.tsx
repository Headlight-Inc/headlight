...
export function FullAuditTraffic() {
	...
	const topPages = useMemo(() => [...pages].sort((a, b) => num(b.sessions || b.ga4Sessions) - num(a.sessions || a.ga4Sessions)).slice(0, 6), [pages])
	const topByConv = useMemo(() => [...pages].sort((a, b) => num(b.ga4Conversions || b.conversions) - num(a.ga4Conversions || a.conversions)).slice(0, 6), [pages])
