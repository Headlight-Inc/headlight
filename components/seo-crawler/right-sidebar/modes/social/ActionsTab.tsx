...
export function ActionsTab({ stats }: RsTabProps<SocialStats>) {
	return (
		<div className="space-y-4">
			<SectionTitle>Top social actions</SectionTitle>
			<Card>
				{stats.topActions.length === 0 ? (
					<div className="text-[11px] italic text-neutral-500">No social actions queued</div>
