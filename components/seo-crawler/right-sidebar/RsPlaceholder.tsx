...
export function RsPlaceholder() {
    return (
        <div id="rs-placeholder" className="flex flex-col items-center justify-center h-full p-8 text-center bg-[#0a0a0a] border-l border-[#222]">
            ...
            <p className="text-[12px] text-[#666] max-w-[200px] leading-relaxed">
                Rebuilding the sidebar architecture for improved performance and modularity.
            </p>
        </div>
    );
}
