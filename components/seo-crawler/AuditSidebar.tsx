    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col shrink-0 bg-[#141414] border-b border-[#222]">
                <div className="h-[40px] px-3 flex items-center justify-between">
                    <h3 className="text-[11px] font-semibold text-[#ccc] uppercase tracking-wider flex items-center gap-2">
                        Audit
                    </h3>
                ...
                <div className="flex px-0 pb-0 overflow-x-auto custom-scrollbar-hidden">
                    {visibleTabs.map(tab => (
                        <button 
                            key={tab.id}
            ...
            <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar bg-[#111] p-3">
