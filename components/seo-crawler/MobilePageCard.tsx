        ...
        >
            <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                    <div className="text-[10px] uppercase tracking-[0.24em] text-[#666]">Page {index + 1}</div>
                    <div className="mt-1 truncate text-[14px] font-semibold text-white">{pathname}</div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-[11px]">
                <div className="rounded-xl border border-[#1c1c20] bg-[#0b0b0d] p-3">
                    ...
                    <div className="mt-1 text-[16px] font-black text-white">{page.healthScore ?? '--'}</div>
                </div>
                <div className="rounded-xl border border-[#1c1c20] bg-[#0b0b0d] p-3">
                    <div className="text-[#666]">LCP</div>
                    <div className="mt-1 text-[16px] font-black text-white">{page.lcp ? `${(Number(page.lcp) / 1000).toFixed(1)}s` : '--'}</div>
                </div>
                <div className="rounded-xl border border-[#1c1c20] bg-[#0b0b0d] p-3">
                    <div className="text-[#666]">Words</div>
                    <div className="mt-1 text-[16px] font-black text-white">{page.wordCount ?? 0}</div>
                </div>
            </div>

            <div className="mt-4 flex items-center justify-between rounded-xl border border-[#22252a] bg-[#0b0c10] px-3 py-2.5">
                <div className="min-w-0">
                    <div className="text-[10px] uppercase tracking-[0.22em] text-[#666]">Primary issue</div>
                    <div className="mt-1 truncate text-[12px] text-[#ddd]">{primaryIssue?.label || 'No major issues detected'}</div>
                </div>
