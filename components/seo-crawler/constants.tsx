...
export const ALL_COLUMNS = [
	...
	{
		key: "indexabilityStatus",
		label: "Indexability Status",
		width: "140px",
		group: "General",
	},
	...
	{
		key: "titleLength",
		label: "Title 1 Length",
		width: "100px",
		group: "General",
	},
	{
		key: "titlePixelWidth",
		label: "Title 1 Pixel Width",
		width: "130px",
		group: "General",
	},
	{
	...
	{
		key: "metaDescLength",
		label: "Meta Description 1 Length",
		width: "160px",
		group: "General",
	},
	{
		key: "metaDescPixelWidth",
		label: "Meta Description 1 Pixel Width",
		width: "180px",
		group: "General",
	},
	{
		key: "metaKeywords",
		label: "Meta Keywords 1",
		width: "200px",
		group: "General",
	},
	{
		key: "metaKeywordsLength",
		label: "Meta Keywords 1 Length",
		width: "160px",
		group: "General",
	},
	...
	{
		key: "industryAction",
		label: "Industry Action",
		width: "180px",
		group: "WQA Actions",
	},
	{
		key: "estimatedImpact",
		label: "Est. Impact (clicks)",
		width: "150px",
		group: "WQA Actions",
	},
	{
	...
	{
		key: "xRobots",
		label: "X-Robots-Tag 1",
		width: "120px",
		group: "Technical",
	},
	{
		key: "metaRefresh",
		label: "Meta Refresh 1",
		width: "120px",
		group: "Technical",
	},
	{
		key: "canonical",
		label: "Canonical Link Element 1",
		width: "350px",
		group: "Technical",
	},
	{
	...
	{
		key: "httpRelNext",
		label: 'HTTP rel="next" 1',
		width: "150px",
		group: "Technical",
	},
	{
		key: "httpRelPrev",
		label: 'HTTP rel="prev" 1',
		width: "150px",
		group: "Technical",
	},
	{
		key: "amphtml",
		label: "amphtml Link Element",
		width: "200px",
		group: "Technical",
	},
	{
	...
	{
		key: "contentTypeCharset",
		label: "Charset",
		width: "110px",
		group: "Technical",
	},
	{
		key: "contentTypeValid",
	...
	{
		key: "sitemapBrokenUrls",
		label: "Broken Sitemap URLs",
		width: "150px",
		group: "Technical",
	},
	{
		key: "sitemapLastmodAccurate",
		label: "Sitemap Lastmod Accurate",
		width: "170px",
		group: "Technical",
	},
	{
		key: "sitemapLastmodMismatchCount",
		label: "Sitemap Lastmod Mismatches",
		width: "190px",
		group: "Technical",
	},
	...
	{
		key: "xRobotsNoindex",
		label: "X-Robots Noindex",
		width: "140px",
		group: "Technical",
	},
	{
		key: "xRobotsNofollow",
		label: "X-Robots Nofollow",
		width: "140px",
		group: "Technical",
	},
	...
	},
	{
		...
		label: "LCP (ms)",
		tooltip:
			"Largest Contentful Paint: Good < 2500ms, Needs Work 2500-4000ms, Poor > 4000ms.",
		width: "100px",
		group: "Metrics",
	},
	...
	{
		key: "renderBlockingCss",
		label: "Render-Blocking CSS",
		width: "150px",
		group: "Metrics",
	},
	{
		key: "renderBlockingJs",
		label: "Render-Blocking JS",
		width: "150px",
		group: "Metrics",
	},
	{
		key: "thirdPartyScriptCount",
	...
	{
		key: "legacyFormatImages",
		label: "Legacy Image Formats",
		width: "150px",
		group: "Metrics",
	},
	{
		key: "modernFormatImages",
		label: "Modern Image Formats",
		width: "150px",
		group: "Metrics",
	},
	{
		key: "imagesWithoutSrcset",
		label: "Images Without Srcset",
		width: "150px",
		group: "Metrics",
	},
	{
		key: "imagesWithoutLazy",
		label: "Images Without Lazy",
		width: "150px",
		group: "Metrics",
	},
	{
		key: "imagesWithoutDimensions",
	...
	{
		key: "uniqueInlinks",
		label: "Unique Inlinks",
		width: "120px",
		group: "Links",
	},
	{
		key: "uniqueJsInlinks",
		label: "Unique JS Inlinks",
		width: "130px",
		group: "Links",
	},
	{
	...
	{
		key: "uniqueOutlinks",
		label: "Unique Outlinks",
		width: "120px",
		group: "Links",
	},
	{
		key: "uniqueJsOutlinks",
		label: "Unique JS Outlinks",
		width: "130px",
		group: "Links",
	},
	{
	...
	{
		key: "uniqueExternalOutlinks",
		label: "Unique External Outlinks",
		width: "180px",
		group: "Links",
	},
	{
		key: "uniqueExternalJsOutlinks",
		label: "Unique External JS Outlinks",
		width: "200px",
		group: "Links",
	},
	...
	// Advanced
	{
		key: "nearDuplicateMatch",
		label: "Closest Near Duplicate Match",
		width: "300px",
		group: "Advanced",
	},
	{
		key: "noNearDuplicates",
		label: "No. Near Duplicates",
		width: "140px",
		group: "Advanced",
	},
	{
	...
	{
		key: "closestSemanticAddress",
		label: "Closest Semantically Similar Address",
		width: "350px",
		group: "Advanced",
	},
	{
	...
	{
		key: "topicCluster",
		label: "AI Topic Cluster",
		width: "200px",
		group: "Advanced",
	},
	{
		key: "internalPageRank",
		label: "Internal PageRank",
		tooltip: "Iterative internal authority score based on the site link graph.",
		width: "150px",
		group: "Advanced",
	},
	{
		key: "linkEquity",
		label: "Link Equity (0-10)",
		tooltip:
			"Composite authority from internal PageRank, backlinks, and content quality.",
		width: "150px",
		group: "Advanced",
	},
	{
		key: "funnelStage",
		label: "Funnel Stage (AI)",
		width: "150px",
		group: "Advanced",
	},
	{
		key: "searchIntent",
		label: "Search Intent (AI)",
		width: "160px",
		group: "Advanced",
	},
	{
	...
	{
		key: "incorrectHeadingOrder",
		label: "Heading Order Issue",
		width: "150px",
		group: "Advanced",
	},
	{
	...
	{
		key: "schemaMissingRequired",
		label: "Schema Missing Required",
		width: "220px",
		group: "Advanced",
	},
	{
		key: "hasBreadcrumbSchema",
	...
	{
		key: "cspHasUnsafeInline",
		label: "CSP Unsafe-Inline",
		width: "150px",
		group: "Security",
	},
	{
		key: "cspHasUnsafeEval",
		label: "CSP Unsafe-Eval",
		width: "140px",
		group: "Security",
	},
	{
		key: "hasXFrameOptions",
		label: "X-Frame-Options",
		width: "130px",
		group: "Security",
	},
	{
		key: "hasXContentTypeOptions",
		label: "X-Content-Type-Options",
		width: "170px",
		group: "Security",
	},
	{
		key: "hasReferrerPolicy",
		label: "Referrer Policy",
		width: "120px",
		group: "Security",
	},
	{
		key: "hasPermissionsPolicy",
	...
	{
		key: "sslDaysUntilExpiry",
		label: "SSL Expiry (days)",
		width: "140px",
		group: "Security",
	},
	{
		key: "sslIsWeakProtocol",
		label: "Weak TLS",
		width: "90px",
		group: "Security",
	},
	...
	{
		key: "cookiesMissingSameSite",
		label: "Cookies Missing SameSite",
		width: "170px",
		group: "Security",
	},
	{
		key: "scriptsWithoutSri",
		label: "Scripts Without SRI",
		width: "140px",
		group: "Security",
	},
	{
		key: "exposedApiKeys",
		label: "Exposed API Keys",
		width: "130px",
		group: "Security",
	},
	{
		key: "privacyPageLinked",
	...
	{
		key: "videosWithoutPoster",
		label: "Videos No Poster",
		width: "140px",
		group: "Metrics",
	},
	{
		key: "videosWithoutLazy",
		label: "Videos No Lazy",
		width: "140px",
		group: "Metrics",
	},
	...
	{
		key: "hasHeaderLandmark",
		label: "Header Landmark",
		width: "130px",
		group: "Accessibility",
	},
	{
		key: "hasFooterLandmark",
	...
	{
		key: "genericLinkTextCount",
		label: "Generic Links",
		width: "120px",
		group: "Accessibility",
	},
	{
		key: "invalidAriaCount",
		label: "Invalid ARIA",
		width: "110px",
		group: "Accessibility",
	},
	{
		key: "tablesWithoutHeaders",
		label: "Tables Without Headers",
		width: "160px",
		group: "Accessibility",
	},
	...
	{
		key: "hasSpacesEncoded",
		label: "Encoded Spaces",
		width: "120px",
		group: "URL Structure",
	},
	...
	{
		key: "bestKwPosition",
		label: "Best KW Position",
		width: "140px",
		group: "Search Console",
	},
	{
		key: "bestKwVolume",
		label: "Best KW Volume",
		width: "140px",
		group: "Search Console",
	},
	...
	{
		key: "sessionsDeltaAbsolute",
		label: "Traffic Δ (Abs)",
		width: "140px",
		group: "Analytics",
	},
	{
		key: "sessionsDeltaPct",
		label: "Traffic Δ (%)",
		width: "120px",
		group: "Analytics",
	},
	...
	{
		key: "ga4ConversionRate",
		label: "Conversion Rate",
		width: "150px",
		group: "Analytics",
	},
	{
		key: "ga4GoalCompletions",
		label: "Goal Completions",
		width: "150px",
		group: "Analytics",
	},
	{
		key: "ga4EcommerceRevenue",
		label: "Ecom Revenue",
		width: "140px",
		group: "Analytics",
	},
	...
	{
		key: "sslChainComplete",
		label: "SSL Chain Complete",
		width: "150px",
		group: "Security",
	},
	{
	...
	{
		key: "hasPassageStructure",
		label: "Passage Ready",
		width: "130px",
		group: "AI Discoverability",
	},
	{
		key: "passageReadiness",
		label: "Passage Readiness (%)",
		width: "150px",
		group: "AI Discoverability",
	},
	{
		key: "hasFeaturedSnippetPatterns",
		label: "Snippet Ready",
		width: "130px",
		group: "AI Discoverability",
	},
	{
		key: "voiceSearchScore",
	...
	{
		key: "aiBotAccessSummary",
		label: "AI Bot Access",
		width: "180px",
		group: "AI Discoverability",
	},
	{
		key: "jsRenderDiff.textDiffPercent",
		label: "JS Text Diff (%)",
		width: "130px",
		group: "Technical",
	},
	{
		key: "jsRenderDiff.jsOnlyLinks",
		label: "JS Only Links",
		width: "120px",
		group: "Technical",
	},
	{
		key: "jsRenderDiff.jsOnlyImages",
		label: "JS Only Images",
		width: "130px",
		group: "Technical",
	},
	{
		key: "jsRenderDiff.criticalContentJsOnly",
		label: "JS Required",
		width: "120px",
		group: "Technical",
	},
	{
		key: "spaRouteBroken",
		label: "SPA Route Broken",
		width: "130px",
		group: "Technical",
	},
	{
		key: "googlebotVisits30d",
		label: "Googlebot (30d)",
		width: "130px",
		group: "Log Analysis",
	},
	{
		key: "botCrawlBudgetShare",
		label: "Crawl Budget %",
		width: "130px",
		group: "Log Analysis",
	},
...
export const resolveIssueCheckId = (
	issueId: string,
	explicitCheckId?: string,
) => {
...
export type CategoryFilterFn = (
	page: any,
	context: CategoryFilterContext,
) => boolean;

const normalizeHostname = (hostname: string | null | undefined) =>
	String(hostname || "")
		.replace(/^www\./i, "")
		.toLowerCase();
...
const containsSchemaType = (page: any, expectedTypes: string[]) => {
	...
	const schemaTypes: string[] = Array.isArray(page?.schemaTypes)
		? page.schemaTypes
		: [];
	return schemaTypes.some((type) =>
		normalizedExpected.includes(String(type || "").toLowerCase()),
	);
};

export const CATEGORY_FILTERS: Record<
	string,
	Record<string, CategoryFilterFn>
> = {
	internal: {
		All: () => true,
		HTML: (page) =>
		...
		JavaScript: (page) =>
			page?.contentType?.includes("javascript") ||
			page?.contentType?.includes("ecmascript"),
	...
	indexability: {
		All: () => true,
		Indexable: (page) =>
			page?.indexable !== false && Number(page?.statusCode || 0) === 200,
		"Non-Indexable": (page) => page?.indexable === false,
		Noindex: (page) =>
			String(page?.metaRobots1 || "")
				.toLowerCase()
				.includes("noindex") || page?.xRobotsNoindex === true,
		Canonicalized: (page) =>
			Boolean(page?.canonical) &&
			String(page?.canonical).trim() !== String(page?.url || "").trim(),
		"Blocked by Robots": (page) => page?.status === "Blocked by Robots.txt",
		"Orphan Pages": (page) =>
			Number(page?.inlinks || 0) === 0 && Number(page?.crawlDepth || 0) > 0,
	},
	codes: {
		All: () => true,
	...
	content: {
		All: () => true,
		"Thin < 300w": (page) =>
			Number(page?.wordCount || 0) > 0 && Number(page?.wordCount || 0) < 300,
		Duplicate: (page) =>
			page?.exactDuplicate === true ||
			page?.isDuplicateTitle === true ||
			page?.isDuplicateMetaDesc === true,
		"Near-Duplicate": (page) =>
			Number(page?.noNearDuplicates || 0) > 0 ||
			Boolean(page?.nearDuplicateMatch),
		...
		"Multiple H1": (page) =>
			page?.multipleH1s === true || Boolean(String(page?.h1_2 || "").trim()),
	...
	schema: {
		All: () => true,
		"Has Schema": (page) =>
			(Array.isArray(page?.schema) && page.schema.length > 0) ||
		...
		Article: (page) =>
			containsSchemaType(page, ["Article", "BlogPosting", "NewsArticle"]),
	...
	performance: {
		All: () => true,
		"Good LCP": (page) =>
			Number(page?.lcp || 0) > 0 && Number(page?.lcp || 0) <= 2500,
		"Needs Work LCP": (page) =>
			Number(page?.lcp || 0) > 2500 && Number(page?.lcp || 0) <= 4000,
		...
		"Render Blocking": (page) =>
			Number(page?.renderBlockingCss || 0) +
				Number(page?.renderBlockingJs || 0) >
			0,
	},
	links: {
		All: () => true,
	...
	images: {
		...
		Oversized: (page) =>
			Number(page?.oversizedImages || 0) > 0 ||
			Number(page?.imagesOver200kb || 0) > 0,
		...
		"No Next-Gen Format": (page) =>
			Number(page?.legacyFormatImages || 0) > 0 &&
			Number(page?.modernFormatImages || 0) === 0,
	},
	mobile: {
		All: () => true,
		...
		"Viewport Issue": (page) =>
			page?.viewportNoScale === true || page?.viewportWidth === false,
	...
	international: {
		All: () => true,
		"Hreflang OK": (page) =>
			Array.isArray(page?.hreflang) &&
			page.hreflang.length > 0 &&
			!page?.hreflangErrors &&
			!page?.hreflangNoSelf &&
			!page?.hreflangInvalid &&
			!page?.hreflangBroken,
		"Hreflang Missing": (page) =>
			!Array.isArray(page?.hreflang) || page.hreflang.length === 0,
		"Hreflang Errors": (page) =>
			page?.hreflangErrors === true ||
			page?.hreflangNoSelf === true ||
			page?.hreflangInvalid === true ||
			page?.hreflangBroken === true,
		"Lang Mismatch": (page) => page?.langMismatch === true,
		"Multi-Language": (page) =>
			Array.isArray(page?.hreflang) && page.hreflang.length > 1,
	},
	pagination: {
		All: () => true,
		"Rel Next/Prev": (page) =>
	...
	architecture: {
		...
		"Depth 2-3": (page) =>
			Number(page?.crawlDepth || 0) >= 2 && Number(page?.crawlDepth || 0) <= 3,
		"Depth 4-5": (page) =>
			Number(page?.crawlDepth || 0) >= 4 && Number(page?.crawlDepth || 0) <= 5,
	...
	"custom-extract": {
		...
		"Emails Found": (page) =>
			Number(page?.extractedEmailsCount || 0) > 0 ||
			(Array.isArray(page?.exposedEmails) && page.exposedEmails.length > 0),
		"Phone Numbers": (page) =>
			Number(page?.extractedPhoneNumbersCount || 0) > 0,
		"Custom Regex": (page) =>
			Number(page?.customRegexMatches || 0) > 0 ||
			(Array.isArray(page?.customExtraction) &&
				page.customExtraction.length > 0),
	},
	"ai-insights": {
		All: () => true,
		"High Priority": (page) =>
			String(page?.strategicPriority || "").toLowerCase() === "high",
		"Quick Wins": (page) =>
			Number(page?.opportunityScore || 0) >= 70 &&
			Number(page?.techHealthScore || 0) >= 60,
		Cannibalization: (page) => page?.isCannibalized === true,
		"Gap Opportunities": (page) => page?.hasContentGap === true,
		"Decay Risk": (page) =>
			String(page?.contentDecay || "")
				.toLowerCase()
				.includes("decay"),
		Sentiment: (page) => Boolean(page?.sentiment),
		AIGenerated: (page) =>
			page?.aiLikelihood === "high" || page?.aiLikelihood === "medium",
	},
	industry: {
		All: () => true,
...
export const CATEGORIES = [
	{
		...
		label: "All Pages",
		icon: <Globe size={14} />,
		sub: ["All", "HTML", "JavaScript", "CSS", "Images", "PDF", "Other"],
	},
	{
		id: "indexability",
		label: "Indexability",
	...
	},
	{
		...
		sub: ["All", "Rel Next/Prev", "Missing Rel", "Paginated"],
	},
	{
		id: "architecture",
		label: "Architecture",
		icon: <GitFork size={14} />,
		sub: ["All", "Depth 0-1", "Depth 2-3", "Depth 4-5", "Depth 6+"],
	},
	{
		id: "custom-extract",
	...
	},
	{
		...
		label: "Industry",
		icon: <GitFork size={14} />,
		sub: ["All", "Ecommerce", "SaaS", "Local", "News", "Healthcare"],
	},
	{
		id: "ai-discoverability",
		label: "AI Discoverability",
		icon: <Sparkles size={14} />,
		sub: ["All", "Passage Ready", "Snippet Ready", "Speakable Ready"],
	},
];
